...
#
# BELT AND BRACES: kernels/caption_kernel.py now resolves audio the same way
# itself (_walk_for_audio + a /kaggle/input fallback, ported from the MOSS kernel)
# after a run mounted the dataset at /kaggle/input/datasets/<owner>/<slug>/ and
# silently captioned nothing. This injection stays because the notebook is the
# hand-run path and prints the folder it resolved.
